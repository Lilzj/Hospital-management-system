...
<div class="main search">
	<div class="nav">
		<ul>
			...
			<li class="current"><a href="docviewpatient.php">View Patient</a></li>	
			<li><a href="docsearchpatient.php">Search Patient</a></li>
		</ul>
	</div>
	<div class="header">
		<h1>View Patients</h1>
...
// To view details from database 
	...
	if (mysqli_num_rows($result) >= 1) {
		...
		while ($row = mysqli_fetch_assoc($result)){
			...
			echo '
				<form method="POST" action="docviewpatient.php">
			<tr>
