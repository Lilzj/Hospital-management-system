...
<div class="body">
	...
	<div class="view-patient">
		<a href="viewpatient.php"><h1>View Patient</h1></a>	
	</div>

	<div class="search-patient">
		<a href="searchpatient.php"><h1>Search Patient</h1></a>
	</div>
	<div>
		<input type="hidden" name="check" value="nurse">
	</div>
	<div class="appointment">
		<a href="appointment.php"><h1>Book Appointment</h1></a>
	</div>

	<div class="logout">
		<a href="nurselogin.php"><h2>logout</h2></a>
	</div>
</div>
</body>
</html>